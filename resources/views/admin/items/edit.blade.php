...
@section('content')
    ...
    <form action="{{ route('item.update', $item->id) }}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="atk" name="atk" value="{{ $item->atk }}" placeholder="Ingrese los puntos de ataque" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="cost" name="cost" value="{{ $item->cost }}" placeholder="Ingrese el precio" required>
        </div>
